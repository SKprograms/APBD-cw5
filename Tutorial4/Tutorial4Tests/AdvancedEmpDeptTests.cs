...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldFindAnyWithCommissionOver400()
    {
        ...
        var result = (from e in emps where e.Comm != null && e.Comm > 400 select e).Any();  
    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
        ...
        var result = emps.Select(e=> new {EName = e.EName, Total = e.Sal+(e.Comm==null?0:e.Comm)}); 
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps.Join(depts,e=>e.DeptNo,d=>d.DeptNo,(e,d)=> new {e.EName,e.Sal,d.DName}).SelectMany((e) => grades.Where(s => e.Sal <= s.Hisal && e.Sal >= s.Losal),
            (e, s) => new { EName = e.EName, DName = e.DName, Grade = s.Grade }); 
